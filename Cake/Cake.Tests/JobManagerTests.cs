...
namespace Cake.Tests
{
    ...
    public class JobManagerTests
    {
        ...
        {
            new Job("first").DependsOn("second", "third");
            new Job("second").DependsOn("fourth");
            new Job("third").DependsOn("fifth");
            new Job("fifth").DependsOn("first");

            JobManager.SetDefault("first");
        }
        /// <summary>
        /// Test method for circular part of graph with dependencies
        /// </summary>
        [TestMethod]
        [TestCategory("CakeMethods")]
        [TestCategory("JobManagerMethods")]
        [ExpectedException(typeof(JobException), "Running a task with a circular dependency was ordered.")]
        public void SetDefaultShouldThrowWhenTheresDependencyCycle2()
        {
